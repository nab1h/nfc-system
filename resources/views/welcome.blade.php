...
<body>
    ...
    <section id="contact" class="py-24 relative">
        ...
        <div class="max-w-3xl mx-auto px-6 relative z-10">
            ...
            <form class="reveal delay-2 bg-card border border-border rounded-2xl p-8 md:p-12" id="contactForm">
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="tel" class="form-input" placeholder="+20 XX XXX XXXX">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-2">الباقة المطلوبة</label>
                ...
                <div class="mb-6">
                    <label class="block text-sm font-medium mb-2">رسالتك</label>
                    <textarea class="form-input h-32 resize-none" placeholder="أخبرنا المزيد عن احتياجاتك..."></textarea>
                </div>
