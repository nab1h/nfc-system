<x-app-layout>
    ...
    <div class="bg-[#111111] border border-[#1a1a1a] rounded-2xl shadow-2xl p-8 max-w-2xl mx-auto my-10">
        ...
        <form method="POST" action="">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="tel" name="phone" placeholder="+966 5XX XXX XXXX" required
                        class="w-full bg-[#0a0a0a] border border-[#1a1a1a] rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-[#E60914] focus:ring-1 focus:ring-[#E60914] transition">
                </div>

                <!-- Email -->
                <div>
                    <label class="block text-sm font-medium text-gray-300 mb-2">البريد الإلكتروني (اختياري)</label>
            ...
            <div class="mt-6">
                ...
                <textarea name="address" rows="3" placeholder="المدينة، الحي، الشارع، رقم المبنى..." required
                    class="w-full bg-[#0a0a0a] border border-[#1a1a1a] rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-[#E60914] focus:ring-1 focus:ring-[#E60914] transition resize-none"></textarea>
            </div>

            <!-- Notes (Full Width) -->
            <div class="mt-6">
                <label class="block text-sm font-medium text-gray-300 mb-2">ملاحظات إضافية</label>
                <textarea name="notes" rows="2" placeholder="تفاصيل إضافية خاصة بالطلب..."
                    class="w-full bg-[#0a0a0a] border border-[#1a1a1a] rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-[#E60914] focus:ring-1 focus:ring-[#E60914] transition resize-none"></textarea>
            </div>
            ...
            <div class="mt-8 flex items-center justify-end gap-4">
                <!-- Cancel Button -->
                <button type="button" class="px-6 py-2.5 border border-gray-700 text-gray-400 rounded-lg hover:bg-gray-800 hover:text-white transition">
                    إلغاء
                </button>
