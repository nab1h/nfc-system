                ...
                <div class="grid grid-cols-4 gap-2">
                    ...
                    <a href="{{ $link->url }}" target="_blank"
                        ...
                        <div class="w-10 h-10 flex items-center justify-center rounded-full bg-green-50 mb-1 group-hover:bg-green-700 transition">
                            ...
                            <i class="fab fa-linkedin-in text-green-600 group-hover:text-white"></i>
                            @elseif($platform == 'twitter' || $platform == 'x')
                            <i class="fab fa-x-twitter text-green-600 group-hover:text-white"></i>
                            @elseif($platform == 'facebook')
                            <i class="fab fa-facebook-f text-green-600 group-hover:text-white"></i>
                            @else
                            <i class="fas fa-link text-green-600 group-hover:text-white"></i>
                            @endif
                        </div>
