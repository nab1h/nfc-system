            ...
            <div class="border-t border-[#222] pt-6">
                ...
                <div class="flex justify-center gap-4">
                    ...
                    <a href="{{ $link->url }}" target="_blank"
                        ...
                        @case('Facebook')
                        <i class="fab fa-facebook-f text-xl text-blue-500 group-hover:text-white"></i> @break
                        @case('Instagram')
                        <i class="fab fa-instagram text-xl text-pink-500 group-hover:text-white"></i> @break
                        @case('TikTok')
                        <i class="fab fa-tiktok text-xl text-white group-hover:text-white"></i> @break
                        @default
                        <i class="fas fa-store text-xl text-gray-400 group-hover:text-white"></i>
                        @endswitch
                    </a>
                    @endforeach
                </div>
