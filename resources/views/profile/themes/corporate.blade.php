...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md glass-effect rounded-3xl card-shadow overflow-hidden border border-gray-100 fade-in relative">
        ...
        <div class="relative px-6 pb-8 text-center">
            ...
            <!-- أزرار التواصل الرسمية -->
            <div class="space-y-3 mb-8">

                <!-- زر البريد الإلكتروني (الأهم للشركات) -->
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <a href="{{ $link->url }}" target="_blank"
                        ...
                        <div class="w-12 h-12 flex items-center justify-center rounded-full bg-slate-50 mb-2 group-hover:bg-slate-800 transition">
                            ...
                            <i class="fab fa-x-twitter text-xl text-slate-800 group-hover:text-white"></i>
                            @elseif($platform == 'facebook')
                            <i class="fab fa-facebook-f text-xl text-slate-800 group-hover:text-white"></i>
                            @else
                            <i class="fas fa-globe text-xl text-slate-500 group-hover:text-white"></i>
                            @endif
                        </div>
